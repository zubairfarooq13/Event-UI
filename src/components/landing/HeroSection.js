...
const HeroSection = () => {
  ...
  return (
    <div className="pt-16 min-h-screen bg-white flex items-center relative">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div className="relative">
              ...
              <form onSubmit={handleSearch} className="flex flex-col md:flex-row md:flex-nowrap md:items-end">
                {/* Event Type */}
                <div ref={eventTypeRef} className="flex-[2.5] border-b md:border-b-0 md:border-r border-gray-200 px-6 py-4 relative min-w-0">
                  <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
                    Event Type
                  </label>
                  <div className="relative">
                    <svg className="absolute left-0 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <input
                      ...
                      className="w-full pl-7 pr-2 py-2 text-gray-700 placeholder-gray-400 focus:outline-none text-base min-w-0"
                    />
                ...
                {/* Guests */}
                <div className="flex-[1.5] border-b md:border-b-0 md:border-r border-gray-200 px-6 py-4 min-w-0">
                  <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
                    Guests
                  </label>
                  <div className="relative">
                ...
                {/* Location */}
                <div ref={locationRef} className="flex-[1.5] border-b md:border-b-0 px-6 py-4 relative min-w-0">
                  <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
                    Location
                  </label>
                  <div className="relative">
              ...
              {/* Background Image - Positioned from Location field onwards */}
              <div className="lg:block absolute top-0 right-0 bottom-0 w-[55%] rounded-2xl overflow-hidden opacity-20 z-0">
                <img
